...
The fixture (tests/signing/golden_temporal_signed_request.json in
openbox-sdk-python) was generated by EXECUTING this repo's signer with an
injected timestamp+nonce. This test proves the local module — before AND
after it delegates to openbox_core.identity — produces those exact bytes.
"""
